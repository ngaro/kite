...
if __name__ == '__main__':
    ...
    disorder_deviation = disorder_strength / (2 * sqrt(3))
    disorder.add_disorder(['Aup', 'Adown'], dis_type='uniform', mean_value=0, standard_deviation=disorder_deviation)
    disorder.add_disorder(['Bup', 'Bdown'], dis_type='uniform', mean_value=0, standard_deviation=disorder_deviation)
    ...
    dirname = 'dis_{:.2f}_k_{:.2f}_sigma_{:.2f}_size_l_{:1d}'.format(disorder_strength * int(use_disorder == True), k, sigma, lx)
